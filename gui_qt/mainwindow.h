...
public:
  ...
  // function that initializes incoming data from memory
  void setupIncomingData();
...
private slots:
  ...
  void screenShot();
  void allScreenShots();
  // function to read from text file "testData.txt" in the same directory
  void readNewData();
  void readNewData2();
